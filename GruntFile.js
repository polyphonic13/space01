		...
		concat: {
			...
			keke2_game: {
				...
				src: [
					...
					'<%= srcDir %>/js/enum/control_codes.js',
					...
					'<%= srcDir %>/js/phaser/controls/control.js',
					'<%= srcDir %>/js/phaser/controls/control_key.js',
			...
			keke_game: {
				...
				src: [
					...
					'<%= srcDir %>/js/kinetic/core/controls/joystick.js',
					'<%= srcDir %>/js/kinetic/core/controls/controls.js',
					'<%= srcDir %>/js/kinetic/core/controls/control_panel.js',
